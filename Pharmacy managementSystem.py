...
########################################################################################################################################################################
        ...
        self.btnRegistration = Button(self.Loginframe3, text = "Patients Registration System",state = DISABLED, command = self.Registration_window,font=('ariel',20,'bold'))
        self.btnRegistration.grid(row = 0, column = 0)


        self.btnHospital = Button(self.Loginframe3, text = "Hospital Management System",state = DISABLED, command = self.Hospital_window,font=('ariel',20,'bold'))
...
#######################################################################################################################################################################
        ...
        self.lblTitle = Label(TitleFrame,text = "Patient Registration  System", font=('ariel',59,'bold'))
        self.lblTitle.grid()
########################################################################################################################################################################        
...
#######################################################################################################################################################################
        ...
        def iPrescription():
            ...
            self.txtPrescription.insert(END,'Reference No: \t\t\t\t' + ReferenceNo.get() + "\n")
        ...
        def iPrescriptionData():
            self.txtFrameDetails.insert(END, cmbNameofTablets.get() + "\t\t" + ReferenceNo.get() + "\t\t" + Dose.get() + "\t\t" + NoofTablets.get() + "\t\t" +
            Lot.get() + "\t\t" + IssueDate.get() + "\t\t" + ExpDate.get() + "\t\t" + DailyDose.get() + "\t\t" + PossibleSideEffects.get() + "\t\t" + StorageAdvice.get() + "\t\t" +  FurtherInformation.get() + "\t\t" + DrivingUsingMachines.get() + "\t\t" + HowtoUseMedication.get() + "\t\t" + PatientID.get() + "\t\t" + NHSNumber.get() + "\t\t" +PatientName.get() + "\t\t" + DateofBirth.get() + "\t\t" + PatientAddress.get() + "\n")
...
####################################################################################################################################################################      
        ...
        self.lblTitle = Label(TitleFrame,text = "\tHospital Management  System\t", font=('ariel',40,'bold'),width = 39,padx = 8)
        self.lblTitle.grid()  
...
######################################################################################################################################################################        
        ...
        self.lblReferenceNo = Label(DataFrameLEFT,text = "Reference No", font=('ariel',12,'bold'),padx = 2,pady = 2)
        ...
        self.lblHowtoUseMedication = Label(DataFrameLEFT,text = "How t oUse Medication", font=('ariel',12,'bold'),padx = 2,pady = 2)
...
####################################################################################################################################################################
        ...
        self.txtPrescription = Label(DataFrameRIGHT, font=('ariel',12,'bold'),padx = 2,pady = 6,width = 43,height = 12)
        self.txtPrescription.grid(row = 0, column = 0)
###################################################################################################################################################################

        self.btnPrescription = Button(ButtonFrame, text = 'Prescription', font = ('ariel',12,'bold'), width = 24, bd = 4,command= iPrescription)
        self.btnPrescription.grid(row = 0,column = 0)

        self.btnPrescriptionData = Button(ButtonFrame, text = 'Prescription Data', font = ('ariel',12,'bold'), width = 24, bd = 4, command = iPrescriptionData)
        self.btnPrescriptionData.grid(row = 0,column = 1)

        self.btnDelete = Button(ButtonFrame, text = 'Delete', font = ('ariel',12,'bold'), width = 24, bd = 4, command = iDelete)
        self.btnDelete.grid(row = 0,column = 2)

        self.btnReset = Button(ButtonFrame, text = 'Reset', font = ('ariel',12,'bold'), width = 24, bd = 4, command = iReset)
        self.btnReset.grid(row = 0,column = 3)

        self.btnExit = Button(ButtonFrame, text = 'Exit', font = ('ariel',12,'bold'), width = 24, bd = 4, command = iExit)
        self.btnExit.grid(row = 0,column = 4)

        
#######################################################################################################################################################################

        self.lblLabel = Label(FrameDetails,font = ('ariel',10,'bold'),pady = 8, text = "Name of Tablets\tReference No\t Dosage \tNo of Tablets\t Lot \t Issued Date\t Exp Date\t Daily Dose\t Storage Adv. \tNHS Number\t Patient Name\t DOB\t Address")
